...
import { getSpeciality, getSpecialitys, ISpecialityGet, ISpecialityPost, ISpecialityPut, putSpecialities } from '../../../api/speciality';
...
const EditSpecialities = () => {
  ...
  return (
    ...
    {specialitie && (
      <EditFormSpecialities specialitie={specialitie} qulification={qualification} onSubmit={onSubmit} />
    )}
  </div>
);
};
